...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/eglogo3.png"  class="spinhov"><img src="<?php echo base_url(); ?>assets/img/eglogo2.png"   class="spinhov3D" ></a></h1>
