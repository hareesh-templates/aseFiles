    ...
    <section id="about-us" class="about-us">
      <div class="container">
        ...
        <div class="row no-gutters" style="margin-bottom: -150px;">
          <div class="col-xl-5 d-flex align-items-stretch justify-content-center justify-content-lg-start" data-aos="fade-right"><img src="<?php echo base_url(); ?>assets/img/aganampudi.jpeg" style="width: 100%;"></div>
         ...
         <div class="row no-gutters" style="margin-top: 100px;">
          ...
          <div class="col-xl-6 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              ...
              <p data-aos="fade-up" style="font-size: 18px; font-family: 'boxicons';">Book a flat of 1055 sq feet at Aganampudi, Vishakhapatnam with ESWARI GROUP. We got you different and easy payment options. With 100% instant payment grab the deal at Rs 30 lakhs. Falling short of cash? With 50% home loan you pay only the rest 50% and book it at Rs 32 lakhs. Grab the deal before it becomes someone else's.</p>
